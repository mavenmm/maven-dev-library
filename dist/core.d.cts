...
interface WorkerListSubtasksParams {
    includeCompletedTasks?: boolean;
    include?: string;
    pageSize?: number;
}
...
interface WorkerCreateSubtaskInput {
    name: string;
...
interface WorkerListProofsParams {
    orderBy?: string;
    orderMode?: "asc" | "desc";
    include?: string;
    limit?: number;
...
interface TeamworkWorkerClient {
     ...
     * under `body.included`. */
    getTask(taskId: string, include?: string): Promise<{
        body: unknown;
        tokenUsed: TeamworkTokenUsed;
    }>;
    ...
    getTaskLegacy(taskId: string): Promise<{
        body: unknown;
        tokenUsed: TeamworkTokenUsed;
    }>;
    /** Raw v3 subtask-list response under `body` for the children of one task. */
    listSubtasks(taskId: string, params?: WorkerListSubtasksParams): Promise<{
        body: unknown;
        tokenUsed: TeamworkTokenUsed;
    }>;
    ...
    createSubtask(parentTaskId: string, input: WorkerCreateSubtaskInput): Promise<{
        id: string;
        tokenUsed: TeamworkTokenUsed;
    }>;
     ...
     * fields, unlike v1). */
    listProjectPeople(projectId: string, pageSize?: number): Promise<{
        body: unknown;
        tokenUsed: TeamworkTokenUsed;
    }>;
